...
export default function FooterActions() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      setIsWarning(remainingMs <= TOTAL_MS * 0.4);
    }, 1000);
      ...
      <div className="flex items-center gap-[10px] sm:gap-[16px] bg-white/90 backdrop-blur-[12px] px-[14px] sm:px-[20px] py-[10px] sm:py-[12px] rounded-[36px] shadow-[0_12px_32px_rgba(0,0,0,0.08)] border-[1px] border-gray-100">
        {isWarning ? (
          <Link
            ...
            href="?modal=hint"
            scroll={false}
            className="w-[44px] h-[44px] sm:w-[48px] sm:h-[48px] rounded-full bg-gray-100 border-none text-black cursor-pointer flex items-center justify-center transition-all duration-200 ease-[cubic-bezier(0.16,1,0.3,1)] hover:bg-gray-200 active:scale-95 active:translate-y-0 relative"
