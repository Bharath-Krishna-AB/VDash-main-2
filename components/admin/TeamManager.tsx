        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
          <div className="relative flex-1 sm:w-80">
            <DeferredSearchInput
              ...
              className="bg-zinc-50 border-2 border-transparent rounded-full py-3 font-bold text-zinc-900 focus:outline-none focus:border-zinc-900 focus:bg-white transition-all shadow-sm placeholder:text-zinc-400"
